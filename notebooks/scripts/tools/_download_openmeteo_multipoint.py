...
Saídas:
  dados/weather/openmeteo_multipoint/pt_LAT_LON.parquet  — série horária por ponto
  dados/weather/openmeteo_multipoint/index.json          — mapa bacia → lista de pontos
"""
...
def main():
    out_dir = Path("dados/weather/openmeteo_multipoint")
