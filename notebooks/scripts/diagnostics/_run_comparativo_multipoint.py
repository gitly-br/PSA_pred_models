...
mp_dir = Path("dados/weather/openmeteo_multipoint")
...
pl.DataFrame(all_results).write_parquet("dados/results/comparativo_multipoint.parquet")
print("\nSalvo em dados/results/comparativo_multipoint.parquet")
