...
with col2:
    with st.container(border=True):
        ...
        <div style='display: flex; flex-direction: column; align-items: center; justify-content: center;margin-bottom: 10px;'>
            <p style='font-size: 20px; font-family: "Source Sans Pro", sans-serif; font-weight: 600; text-align: center; color: #333; margin: 10px 0; line-height: 1.2;'>Amanhã<br>{st.session_state.predict_date}</p>
